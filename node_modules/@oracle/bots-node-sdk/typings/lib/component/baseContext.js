...
exports.BaseContext = exports.NLPResult = void 0;
...
class BaseContext {
    ...
    constructor(request, response, validationSchema) {
        ...
        if (validation && validation.error) {
            ...
            err.name = 'badRequest';
            err.details = createErrorDetails('Request body malformed', JSON.stringify(validation.error), 'BOTS-1000', {
                requestBody: request,
            });
            throw err;
        }
   ...
   */
    ...
    constructMessagePayload(payload) {
        let messagePayload;
        let messageModel;
        if (payload instanceof lib2_1.RawMessage) {
            // message created with new MessageFactory
            return payload.toJson();
        }
        else if (payload instanceof lib2_1.NonRawMessage) {
            // message created with new MessageFactory
            return payload.toJson();
        }
        ...
        if (messageModel.isValid()) {
            ...
            let rawMessagePayload = messageModel_1.MessageModel.rawConversationMessage(payload);
...
function createErrorDetails(title, detail, errorCode, errorDetails) {
    const details = Object.assign({}, error_1.ERROR);
    details.title = title;
...
function validateRequestSchema(reqBody, validationSchema) {
    return validator_1.CommonValidator.validate(validationSchema, reqBody, { allowUnknown: true });
}
