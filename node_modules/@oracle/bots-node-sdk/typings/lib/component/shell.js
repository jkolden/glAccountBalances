...
function ComponentShell(config, registry) {
    ...
    if (!logger) {
        logger = provider_1.CommonProvider.getLogger();
    }
    // Registry validation
    ...
    return {
        ...
        getAllComponentMetadata: function () {
            ...
            let allMetadata = {
                version: sdk_1.CustomComponentContext.sdkVersion(),
        ...
        invokeComponentByName: function (componentName, requestBody, sdkMixin, callback) {
            ...
            try {
                const { component, context } = resolveInvocation(componentName, requestBody, sdk_1.CustomComponentContext, sdkMixin);
        ...
        invokeResolveEntitiesEventHandler: function (componentName, requestBody, callback, sdkMixin) {
            ...
            try {
                const { component, context } = resolveInvocation(componentName, requestBody, entity_1.EntityResolutionContext, sdkMixin);
...
exports.ComponentShell = ComponentShell;
